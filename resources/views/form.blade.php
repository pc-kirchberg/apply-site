        ...
        @else
          ...
          <form action="{{ route('submit') }}" method="post" id="form">
            ...
            <div class="form-field">
              ...
              <small>Bear in mind that this is only an indication of preference and not a final selection. The final
                positions will be decided during the committee nomination and voting process
              </small>
